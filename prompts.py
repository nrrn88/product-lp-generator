...
- 構成: 
  ...
  2. 商品概要・結論
  3. この医薬品が必要な人・ニーズが合わない人
     - **【重要】：このセクションの「ニーズが合わない人」には、心臓病などの医学的な禁忌情報は絶対に書かないでください。**
     - ここにはあくまで「ユーザーの目的と合わないケース（マーケティング的なミスマッチ）」を記述してください。
     - **OK例**: 「即効性を最優先する人（効果発現に1時間かかるため）」「毎日服用するタイプを探している人」「医師の診察を必須と考える人」
     - **NG例**: 「心臓病の人」「肝臓障害のある人」（これらは「6. 注意点」に記述すること）
  4. 成分・作用機序（表形式）
  5. 効果・効能
  6. 用法・用量・副作用・注意点（※ここで医学的な「服用してはいけない人」「併用禁忌」を詳しく解説してください）
  7. よくある質問 (FAQ)
</html_content>
