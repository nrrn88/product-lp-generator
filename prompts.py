...
- 構成: 
  ...
  3. この医薬品が必要な人・ニーズが合わない人
     - **【重要】：このセクションの「ニーズが合わない人」には、心臓病、高血圧、肝臓病、未成年などの「使用禁忌（医学的理由）」は絶対に書かないでください。**
     - ここにはあくまで「ユーザーの嗜好や目的と合わないケース」を記述してください。
     - **OK例**: 「服用のタイミング（1時間前）を待てない人」「即効性を最優先する人」
     - **NG例**: 「心臓に持病がある人」「併用禁忌薬を飲んでいる人」（これらはセクション6へ）
  4. 成分・作用機序（表形式）
  5. 効果・効能
